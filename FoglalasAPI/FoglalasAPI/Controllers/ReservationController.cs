...
namespace FoglalasAPI.Controllers
{
    ...
    public class ReservationController : Controller
    {
        ...
        [HttpGet]
        [Route("GetRestaurantAll/{restaurantId}")]
        public IEnumerable<Reservation> GetRestaurantAllReservations(int restaurantId)
        {
            return (from r in _appDbContext.Reservations
        ...
        {
            _appDbContext.Database.ExecuteSqlRaw($"DELETE FROM \"Reservations\" WHERE \"ReservationId\" = {reservationId}");
            _appDbContext.Database.ExecuteSqlRaw($"DELETE FROM \"ReservedTables\" WHERE \"ReservationId\" = {reservationId}");
            _appDbContext.SaveChanges();
            return Ok();
        }
    }
